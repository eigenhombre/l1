...
func TestEval(t *testing.T) {
	...
	var tests = []struct {
		...
		{Cases(S("(pos?)", "", "expects a single argument"))},
		{Cases(S("(pos? 1 1)", "", "expects a single argument"))},
		{Cases(S("(pos? 0)", "()", OK))},
		{ECases(S("(pos? 1)", "t", OK))},
		{ECases(S("(neg? -1)", "t", OK))},
		{Cases(S("(pos? (quote one))", "", "is not a number"))},
		{Cases(S("(< t 1)", "", "is not a number"))},
		{Cases(S("(< 1 t)", "", "is not a number"))},
		{Cases(S("(< 1 2)", "t", OK))},
		{ECases(S("(< 1 2 3)", "t", OK))},
		{Cases(S("(< 1 2 3 3)", "()", OK))},
		{ECases(S("(<= 1 2 3 3)", "t", OK))},
		{Cases(S("(< 1 2 1)", "()", OK))},
		{Cases(S("(< 2 1)", "()", OK))},
		{Cases(S("(< 2 1 3)", "()", OK))},
		{Cases(S("(> 1)", "t", OK))},
		{Cases(S("(> 3 2 1 0)", "t", OK))},
		{Cases(S("(< 0 0)", "()", OK))},
		{Cases(S("(> 3 2 1 1)", "()", OK))},
		{ECases(S("(> 3 2 1 0)", "t", OK))},
		{ECases(S("(>= 3 2 1 1)", "t", OK))},
		...
		{ECases(S("(apply = (split (quote ooo)))", "t", OK))},
		{ECases(S("(apply = (split (quote foo)))", "()", OK))},
		{Cases(S("(apply (lambda (x y) (= x y)) (split 11))", "t", OK))},
		{Cases(S("(apply (lambda (x y) (= x y)) (split 123))", "", "wrong number of args"))},
		{ECases(S("(apply (lambda (x y z) (= x y z)) (split 121))", "()", OK))},
